    ...
    <div class="latest-products">
      <div class="container">
        <div class="row">
          ...
          <?php
          $select=mysqli_query($conn,"SELECT * FROM tbl_product ORDER BY reg_date DESC LIMIT 3");
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="index.php?page=product_detail&itemid=<?php echo $row['product_id']; ?>"><h4><?php echo $row['product_name']; ?></h4></a>
